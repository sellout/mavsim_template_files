"""
example of drawing a box-like mav in python
...
class mav_viewer():
    ...
    def _get_mav_points(self):
        ...
        """
        # various dimensions of the aircraft
        fuse_h = 2
        fuse_l1 = 3
        fuse_l2 = 1
        fuse_l3 = 6
        ...
        points = np.array([[fuse_l1, 0, 0],  # point 1
                           [fuse_l2, -(fuse_h / 2), fuse_w / 2],  # point 2
                           [fuse_l2, -(fuse_h / 2), -(fuse_w / 2)],  # point 3
                           [fuse_l2, fuse_h / 2, -(fuse_w / 2)],  # point 4
                           [fuse_l2, fuse_h / 2, fuse_w / 2],  # point 5
                           [-(fuse_l3), 0, 0],  # point 6
        ...
        meshColors[4] = blue  # fuse
        meshColors[5] = blue  # fuse
        meshColors[6] = blue  # fuse
        meshColors[7] = blue  # fuse
    ...
    def _points_to_mesh(self, points):
        ...
        mesh = np.array([[points[0], points[1], points[2]],  # nose
                         ...
                         [points[5], points[1], points[2]],  # fuse
                         [points[5], points[2], points[3]],  # fuse
                         [points[5], points[3], points[4]],  # fuse
                         [points[5], points[4], points[1]],  # fuse
